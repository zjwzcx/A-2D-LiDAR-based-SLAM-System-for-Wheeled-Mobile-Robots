...
class Extraction():
    def __init__(self):
        ...
        self.range_threshold = rospy.get_param('/extraction/range_threshold', 0.5)
        # threshold of certain obstacle as the feature of map
        self.radius_max_th = rospy.get_param('/extraction/radius_max_th', 0.4)
