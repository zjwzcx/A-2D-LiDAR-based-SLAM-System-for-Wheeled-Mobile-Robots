...
class Tracking: # Subscriber -> pathCallback() -> initTracking()/ -> updateGlobalPose() -> trackThreadFunc() -> planOnce()
    ...
    def updateGlobalPose(self):
        ...
        #lgoal = self.tf.transformPose("/map", self.path.poses[self.goal_index])
        #print "=====================", self.path.poses[self.goal_index], "======================"
    ...
    def planOnce(self): # compute the velocity
        ...
        #print "k2 * (alpha - math.atan(-k1 * beta)) is: ", k2 * (alpha - math.atan(-k1 * beta))
        #print "gamma is: ", gamma
        print "rho is: ", rho
        miu, langda, v_max = 0.1, 1, 2.5
